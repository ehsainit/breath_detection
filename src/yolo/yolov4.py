...
class YOLOv4:
    ...
    def __init__(self, config, model, labels, size=416, confidence=0.8, threshold=0.8, use_gpu=False):
        ...
        try:
            ...
            raise ValueError("Couldn't find the yolo-models!\nDid you forget to download them manually"
                             " (and keep in the correct directory, yolo-models/) or run the shell script?")
    ...
    def inference(self, image):
        ...
        if len(idxs) > 0:
            for i in idxs.flatten():
                ...
                results.append((confidence, x, y, w, h))
